...
class TenantFrontendController extends Controller
{
    ...
    public function dynamic_single_page($slug)
    {
        ...
        if ($slug === $shop_page_slug) {
            if (tenant()) {
                $product_object = Product::where('status_id', 1)->latest()->withSum('taxOptions', 'rate')->paginate(100);
        ...
        if (tenant_has_digital_product() && $slug === $digital_shop_page_slug) {
            if (tenant()) {
                $product_object = DigitalProduct::where('status_id', 1)->latest()->paginate(100);
    ...
    public function shop_page(Request $request)
    {
        ...
        $product_object = $product_object->all()->withQueryString();
...
HTML;
    ...
    public function category_products($slug, $category_type = null)
    {
        ...
        $products = Product::whereIn('id', $products_id)->paginate(100);
