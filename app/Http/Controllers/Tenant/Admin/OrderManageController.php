...
class OrderManageController extends Controller
{
    ...
    public function export(Request $request)
    {
        ...
        //        return view(self::ROOT_PATH . 'pdf.test', compact('all_orders'));

        if ($request->type == 'pdf') {
            $pdf = MPDF::loadView(self::ROOT_PATH . 'pdf.orders', compact('all_orders'));
        ...
        $pdf = PDF::loadView(self::ROOT_PATH . 'order-manage-all', compact('all_orders'));
        return $pdf->download('all-orders.pdf');
    }
