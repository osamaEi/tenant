...
<?php endif; ?>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <form action="<?php echo e(route('tenant.admin.sales.settings')); ?>" method="POST">
                            <?php echo csrf_field(); ?>

                                <div class="form-group">
                                    <label for="workday"><?php echo e(__('Week Starting Day')); ?></label>
                                    <select class="form-control mt-3" name="first_workday" id="workday">
                                        <?php $__currentLoopData = $daysOfWeek; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($key); ?>" <?php echo e(get_static_option('first_workday') == $key ? 'selected' : ''); ?>><?php echo e(__($day)); ?></option>
...
<?php $__env->startSection('scripts'); ?>
    <script src="<?php echo e(asset('landlord/admin/js/apexcharts.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('tenant.admin.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/Modules/SalesReport/Resources/views/tenant/admin/settings.blade.php ENDPATH**/ ?>