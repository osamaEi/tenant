    ...
    $(function () {
        $(document).ready(function () {
            $(document).on('click', '.physical-explore-category-area .store-tabs .list', function (e) {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(route('tenant.category.wise.product.bookpoint.physical')); ?>",
                    data: {
                        category: tab,
                        limit: limit,
                        allId: allId,
            ...
            $(document).on('click', '.digital-explore-category-area .store-tabs .list', function (e) {
                ...
                $.ajax({
                    type: 'GET',
                    url: "<?php echo e(route('tenant.category.wise.product.bookpoint')); ?>",
                    data: {
                        category: tab,
                        limit: limit,
                        allId: allId,
...
<?php if(in_array(tenant()->theme_slug, ['casual', 'electro'])): ?>
    <script>
        $(function () {
            $(document).on('click', '.product-list .list', function (e) {
                ...
                const url = `<?php echo e(route('tenant.category.wise.product.'.tenant()->theme_slug)); ?>`;
...
<?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/components/tenant-addon-custom-js.blade.php ENDPATH**/ ?>