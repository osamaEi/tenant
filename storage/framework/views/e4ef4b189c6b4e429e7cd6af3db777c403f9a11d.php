...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                <h4 class="header-title mb-4"><?php echo e(__('Send Mail To All Newsletter Subscriber')); ?></h4>
                <form action="<?php echo e(route('tenant.admin.newsletter.mail')); ?>" method="post" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make(route_prefix().'admin.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/tenant/admin/newsletter/send-mail-to-all.blade.php ENDPATH**/ ?>