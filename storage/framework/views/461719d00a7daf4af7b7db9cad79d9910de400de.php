                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                <div class="col-xxl-12 col-lg-12 col-md-12">
                                    <div class="single-blog-two text-center">
                                        <p class="text-warning"><?php echo e(__('No Blog Found')); ?></p>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
...
<?php echo $__env->make('tenant.frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/Modules/Blog/Resources/views/tenant/frontend/blog/blog-tags.blade.php ENDPATH**/ ?>