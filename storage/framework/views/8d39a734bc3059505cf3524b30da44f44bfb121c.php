<div class="single-shop-details-wrapper">
    ...
    <div class="name_badge d-flex">
        <h2 class="details-title"> <?php echo $product->name; ?>
            ...
            <div
                class="value-input-area single-input-list mt-4 size_list  <?php echo e($quickView ? "quick-view-value-input-area" : ""); ?>">
                    <span class="input-title fw-500 color-heading">
                        ...
                        <input type="hidden" id="selected_size" value="<?php echo e($productSizes[0]->id); ?>">
                    </span>
                <ul class="size-lists select-list <?php echo e($quickView ? "quick-view-size-lists" : ""); ?>" data-type="Size">
                    <?php $__currentLoopData = $productSizes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $product_size): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!empty($product_size)): ?>
                            <li class="list<?php echo e($key === 0 ? ' active' : ''); ?>"
...
<?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/themes/casual/frontend/shop/product_details/partials/product-options.blade.php ENDPATH**/ ?>