<?php $__env->startSection('title'); ?> <?php echo e(__('All Blogs')); ?> <?php $__env->stopSection(); ?>
...
<?php $component->withAttributes([]); ?>
                     <?php $__env->slot('left', null, []); ?> 
                        <h4 class="header-title mb-4"><?php echo e(__('All Blog Items')); ?> </h4>
                     <?php $__env->endSlot(); ?>

                     <?php $__env->slot('right', null, ['class' => 'd-flex']); ?> 
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.link-with-popover','data' => ['permissions' => 'blog-create','url' => ''.e(route(route_prefix().'admin.blog.new')).'','extraclass' => 'ml-3']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['permissions' => 'blog-create','url' => ''.e(route(route_prefix().'admin.blog.new')).'','extraclass' => 'ml-3']); ?>
...
<?php endif; ?>
                ...
                <div class="table-wrap table-responsive ">
                    <table class="table table-default table-striped table-bordered" id="all_blog_table" >
                        ...
                        <th><?php echo e(__('Title & Info')); ?></th>
...
<?php $__env->startSection('scripts'); ?>
    <?php echo $__env->make('components.datatable.yajra-scripts',['only_js' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action-js','data' => ['url' => route(route_prefix().'admin.blog.bulk.action')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route(route_prefix().'admin.blog.bulk.action'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
        ...
        (function ($) {
            ...
            $(document).ready(function () {
                ...
                $('.table-wrap > table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "<?php echo e(route(route_prefix().'admin.blog',['lang' => $default_lang])); ?>",
                    columns: [
...
<?php echo $__env->make(route_prefix().'admin.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/Modules/Blog/Resources/views/landlord/admin/blog/index.blade.php ENDPATH**/ ?>