    ...
    (function ($) {
        ...
        $(document).ready(function () {
            ...
            $('.add_to_compare_ajax').on('click', function (e) {
                ...
                let product_id = $(this).data('id');
                $.ajax({
                    url: '<?php echo e(route("tenant.shop.compare.product")); ?>',
                    type: 'POST',
                    data: {
                        product_id: product_id,
                        _token: '<?php echo e(csrf_token()); ?>'
...
<?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/components/tenant/product/quick-view-js.blade.php ENDPATH**/ ?>