...
<?php $__env->startSection('content'); ?>
        ...
        <div class="container custom-container-one">
            <div class="book-details-wrapper">
                <div class="book-details-wrapper-flex">
                    ...
                    <?php echo $__env->make(include_theme_path('digital-shop.product_details.partials.details'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!-- Book details Area start -->

                    <!-- Book sidebar details Area start -->
                    <?php echo $__env->make(include_theme_path('digital-shop.product_details.partials.details-sidebar'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <!-- Book sidebar details Area start -->
                </div>
            </div>
        </div>
    ...
    <?php echo $__env->make(include_theme_path('digital-shop.product_details.partials.description-review'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        $(function (){
            ...
            $(document).on('click', '#review-submit-btn', function (e){
                ...
                $.ajax({
                    url: '<?php echo e(route('tenant.digital.shop.product.review')); ?>',
                    type: 'POST',
                    data: {
                    ...
                    beforeSend: function (){
                        toastr.warning('<?php echo e(__('Submitting please wait.')); ?>', 5000)
    ...
    <script>
        ...
        $(document).on('click', '.add_to_wishlist_single_page', function (e) {
            ...
            let has_campaign = '<?php echo e(empty($campaign_product) ? 0 : 1); ?>';
            let campaign_expired = '<?php echo e(isset($is_expired) ? $is_expired : 0); ?>';

            if(has_campaign == 1)
            {
                if (campaign_expired == 0)
                {
                    toastr.error('<?php echo e(__('The campaign is over, Sorry! you can not cart this product')); ?>');
                    return false;
                }
            }
...
<?php echo $__env->make(route_prefix().'frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/themes/electro/frontend/digital-shop/product_details/product-details.blade.php ENDPATH**/ ?>