...
<?php $__env->startSection('section'); ?>
    <style>
        ...
        <a href="<?php echo e(route('tenant.frontend.support.ticket')); ?>" class="btn btn-info margin-bottom-30"><?php echo e(__('New Ticket')); ?></a>
                ...
                <table class="table table-striped">
                    ...
                    <?php $__currentLoopData = $all_tickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('tenant.user.dashboard.support.ticket.view',$data->id)); ?>"  class="btn btn-info text-white btn-xs" target="_blank">
    ...
    <script>
        (function (){
            ...
            $(document).on('click','.change_priority',function (e){
                ...
                $.ajax({
                    'type': 'post',
                    'url' : "<?php echo e(route('tenant.user.dashboard.support.ticket.priority.change')); ?>",
                    'data' : {
            ...
            $(document).on('click','.status_change',function (e){
                ...
                $.ajax({
                    'type': 'post',
                    'url' : "<?php echo e(route('tenant.user.dashboard.support.ticket.status.change')); ?>",
                    'data' : {
                        _token : "<?php echo e(csrf_token()); ?>",
                        status : status,
                        id : id,
...
<?php echo $__env->make('tenant.frontend.user.dashboard.user-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/tenant/frontend/user/dashboard/support-tickets.blade.php ENDPATH**/ ?>