...
<?php $__env->startSection('style'); ?>
    <link rel="stylesheet" href="<?php echo e(global_asset('assets/common/css/nestable.css')); ?>">
<?php $__env->stopSection(); ?>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="header-wrapper d-flex justify-content-between">
                            <h4 class="header-title mb-4"><?php echo e(__('Edit Menu')); ?></h4>
                            <div class="btn-wrapper">
                                <a href="<?php echo e(route('tenant.admin.menu')); ?>" class="btn btn-primary btn-xs"><?php echo e(__('All Menus')); ?></a>
                            </div>
                        </div>
                        <form action="<?php echo e(route('tenant.admin.menu.update',$page_post->id)); ?>" id="menu_update_form" method="post"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="menu-left-side-content">
                                        <h3 class="title mb-4"><?php echo e(__('Add menu items')); ?></h3>
                                   ...
                                   <div class="menu-structure-wrapper">
                                       <div class="card">
                                           <div class="card-header">
                                               <h3 class="title mb-4"><?php echo e(__('Menu Structure')); ?></h3>
                                           </div>
...
<?php $__env->startSection('scripts'); ?>
    <script src="<?php echo e(global_asset('assets/common/js/jquery.nestable.js')); ?>"></script>
    <script>
        $(document).ready(function () {
            ...
            $(document).on('click','.add_mega_menu_to_menu',function (e) {
                ...
                $.each(allList,function (index,value) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo e(route('tenant.admin.mega.menu.item.select.markup')); ?>",
                        data:{
...
<?php echo $__env->make(route_prefix().'admin.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/tenant/admin/menu/menu-edit.blade.php ENDPATH**/ ?>