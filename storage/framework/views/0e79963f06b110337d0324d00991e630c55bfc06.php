...
<?php endif; ?>
            ...
            <div class="col-lg-7">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title mb-4"><?php echo e(__('All Shipping Zones')); ?></h4>
...
<?php endif; ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action.td','data' => ['id' => $zone->id]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                        ...
                                        <td>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('shipping-zone-delete')): ?>
                                            <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.table.btn.swal.delete','data' => ['route' => route('tenant.admin.shipping.zone.delete', $zone->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('tenant.admin.shipping.zone.delete', $zone->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
            ...
            <div class="col-lg-5">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route('tenant.admin.shipping.zone.new')); ?>" method="post" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <small class="text-warning"><?php echo e(__('First select all the desired countries.')); ?></small>
    ...
    <div class="modal fade" id="shipping_zone_edit_modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="<?php echo e(route('tenant.admin.shipping.zone.update')); ?>"  method="post">
...
<?php endif; ?>
    <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.bulk-action.js','data' => ['route' => route('tenant.admin.shipping.zone.bulk.action')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['route' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route('tenant.admin.shipping.zone.bulk.action'))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
    ...
    $(document).ready(function () {
        ...
        $('#country').on('change', function () {
            let id = $(this).val();
            $.post('<?php echo e(route("tenant.admin.state.by.multiple.country")); ?>', {id:id,_token: "<?php echo e(csrf_token()); ?>"}).then(function (data) {
                $('#state').html('');
        ...
        $(document).on('click','.shipping_zone_edit_btn',function(){
            ...
            $.post('<?php echo e(route("tenant.admin.state.by.multiple.country")); ?>', {id:country,_token: "<?php echo e(csrf_token()); ?>"}).then(function (data) {
                for (const state of data) {
...
<?php echo $__env->make('tenant.admin.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/Modules/ShippingModule/Resources/views/tenant/admin/zone/all.blade.php ENDPATH**/ ?>