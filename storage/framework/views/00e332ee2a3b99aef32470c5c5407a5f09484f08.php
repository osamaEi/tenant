...
<?php endif; ?>
            ...
            <div class="col-lg-7">
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title mb-4"><?php echo e(__('All Languages')); ?></h4>
                        <?php if(tenant()): ?>
                            <p class="text-primary"><?php echo e(__('Landlord will generate translations for each languages')); ?></p>
                        <?php endif; ?>
                                ...
                                <table class="table table-default">
                                    ...
                                    <?php $__currentLoopData = $all_lang; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><?php echo e(strtoupper(\App\Enums\LanguageEnums::getdirection($data->direction))); ?></td>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('language-edit')): ?>
                                                    ...
                                                    <?php else: ?>
                                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.change-default-lang','data' => ['url' => route(route_prefix().'admin.languages.default',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route(route_prefix().'admin.languages.default',$data->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
                                            ...
                                            <td>
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('language-delete')): ?>
                                                    <?php if($data->default != 1): ?>
                                                        ...
                                                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.delete-popover','data' => ['url' => route(route_prefix().'admin.languages.delete',$data->id)]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['url' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(route(route_prefix().'admin.languages.delete',$data->id))]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
<?php $component = $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4; ?>
...
<?php endif; ?>
                                                ...
                                                <?php endif; ?>
                                                <?php if(!tenant()): ?>
                                                    <a href="<?php echo e(route(route_prefix().'admin.languages.words.all',$data->slug)); ?>"
                                                       title="<?php echo e(__('Edit Frontend Words')); ?>"
                ...
                <div class="col-lg-5">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="<?php echo e(route(route_prefix().'admin.languages.new')); ?>" method="post"
                                ...
                                <div class="form-group">
                                    ...
                                    <?php else: ?>
                                        ...
                                        ?>
                                        <select name="language_select" class="form-control">
                                            <?php $__currentLoopData = json_decode($languages) ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($language->slug); ?>" lang="<?php echo e($language->slug); ?>"><?php echo e(__($language->name)); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    <?php endif; ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="direction" id="direction" class="form-control">
                                        <option value="0"><?php echo e(__('LTR')); ?></option>
                                        <option value="1"><?php echo e(__("RTL")); ?></option>
                                    </select>
                                </div>
                                <div class="form-group">
        ...
        <div class="modal fade" id="language_item_edit_modal" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route(route_prefix().'admin.languages.update')); ?>" class="edit_language_form"
                          method="post">
            ...
            <div class="modal fade" id="language_item_clone_modal" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form action="<?php echo e(route(route_prefix().'admin.languages.clone')); ?>"
...
<?php echo $__env->make($route_name.'.admin.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/landlord/admin/languages/index.blade.php ENDPATH**/ ?>