                    ...
                    <div class="card-body">
                        <div class="header-wrap d-flex justify-content-between">
                            <div class="btn-wrapper">
                                <a href="<?php echo e(route(route_prefix().'admin.form.builder.all')); ?>" class="btn btn-secondary"><?php echo e(__('All Form')); ?></a>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="<?php echo e(route(route_prefix().'admin.form.builder.update')); ?>" method="Post">
                            <?php echo csrf_field(); ?>
...
<?php $__env->startSection('scripts'); ?>
    <script src="<?php echo e(global_asset('assets/plugins/PageBuilder/js/jquery-ui.min.js')); ?>"></script>
    <script>
        (function ($) {
            "use strict";
...
<?php echo $__env->make(route_prefix().'admin.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/landlord/admin/form-builder/custom/edit.blade.php ENDPATH**/ ?>