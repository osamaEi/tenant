<script>
    ...
    */
    ...
    $(document).on("click",".status-dropdown .dropdown-menu li",function (){
        ...
        send_ajax_request("post", data, '<?php echo e(route('tenant.admin.product.update.status')); ?>', function () {
...
<?php /**PATH /home/exchangemails/amstechs.com/core/Modules/Product/Resources/views/components/table/status-js.blade.php ENDPATH**/ ?>