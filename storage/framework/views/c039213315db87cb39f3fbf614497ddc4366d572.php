        ...
        $(function () {
            ...
            $(document).on('click', '#review-submit-btn', function (e) {
                ...
                $.ajax({
                    ...
                    beforeSend: function () {
                        CustomSweetalertTwo.warning('<?php echo e(__('Submitting please wait.')); ?>')
    ...
    <script>
        ...
        function getAttributesForCart() {
            ...
            if (Object.keys(selected_options).length) {
                CustomSweetalertTwo.error(`<?php echo e(__('Attribute not available')); ?>`);
            }
        ...
        $(document).on('click', '.add_to_cart_single_page', function (e) {
            ...
            if (validateSelectedAttributes()) {
                $.ajax({
                    ...
                    error: function (err) {
                        CustomSweetalertTwo.error('<?php echo e(__("An error occurred")); ?>');
                    }
                });
            } else {
                CustomSweetalertTwo.error('<?php echo e(__("Select all attribute to proceed")); ?>');
            }
        });
...
<?php echo $__env->make(route_prefix().'frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/themes/electro/frontend/shop/product_details/product-details.blade.php ENDPATH**/ ?>