        ...
        <div class="checkout-inner mt-4 mt-lg-5">
            ...
            <div class="checkout-inner-contents">
                <div class="checkout-form-wrapper mt-2">
                    <form action="<?php echo e(route('tenant.shop.checkout')); ?>" method="POST" class="checkout-form"
                        ...
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> <?php echo e(__('First Name')); ?>
...
<?php endif; ?>
                                ...
                                <input class="form--control" type="text" name="name"
                                    ...
                                    value="<?php if(auth()->guard('web')->check()): ?><?php echo e($billing_info ? $billing_info->full_name:auth('web')->user()?->name); ?><?php else: ?><?php echo e(old('name')); ?><?php endif; ?>"
                                    <?php echo e($readonly); ?>>
                            </div>
                        </div>
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> <?php echo e(__('Mobile Number')); ?>
...
<?php endif; ?>
                                ...
                                <input class="form--control" type="tel" placeholder="<?php echo e(__('Type Mobile Number')); ?>"
                                    name="phone"
                                    value="<?php if(auth()->guard('web')->check()): ?><?php echo e($billing_info ? $billing_info->phone : (!empty(auth('web')->user()?->mobile) ? auth('web')->user()?->mobile : old('phone'))); ?><?php else: ?><?php echo e(old('phone')); ?><?php endif; ?>"
                                    <?php echo e($readonly); ?>>
                            </div>
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> <?php echo e(__('Email Address')); ?>
...
<?php endif; ?>
                                ...
                                <input class="form--control" type="email" placeholder="<?php echo e(__('Type Email')); ?>"
                                    name="email"
                                    value="<?php if(auth()->guard('web')->check()): ?><?php echo e($billing_info ? $billing_info->email : auth('web')->user()?->email); ?><?php else: ?><?php echo e(old('email')); ?><?php endif; ?>"
                                    <?php echo e($readonly); ?>>
                            </div>
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> <?php echo e(__('ZIP / PIN Code')); ?>
...
<?php endif; ?>
                                ...
                                <input class="form--control" type="text" placeholder="<?php echo e(__('ZIP / PIN Code')); ?>"
                                    name="postal_code" maxlength="6"
                                    value="<?php if(auth()->guard('web')->check()): ?><?php echo e($billing_info ? $billing_info->postal_code : auth('web')->user()?->postal_code); ?><?php else: ?><?php echo e(old('postal_code')); ?><?php endif; ?>"
                                    <?php echo e($readonly); ?>>
                            </div>
                        </div>
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> <?php echo e(__('Country')); ?>
...
<?php endif; ?>
                        ...
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> <?php echo e(__('Address')); ?>
...
<?php endif; ?>
                                ...
                                <textarea class="form--control form--message" name="address"
                                    placeholder="<?php echo e(__('Type Address')); ?>"
                                    <?php echo e($readonly); ?>><?php if(auth()->guard('web')->check()): ?><?php echo e($billing_info ? $billing_info->address : (!empty(auth('web')->user()?->address) ? auth('web')->user()?->address : old('address'))); ?><?php else: ?><?php echo e(old('address')); ?><?php endif; ?></textarea>
                            </div>
                        </div>

                        <?php if(!Auth::guard('web')->check()): ?>
                        <div class="create-account-wrapper mt-4 mt-lg-5">
                            <a href="javascript:void(0)" class="create-accounts click-open-form2 fw-500 color-heading">
                                <?php echo e(__('Create An Accounts')); ?> </a>
                                ...
                                <div class="checkout-form-flex">
                                    <div class="single-input">
                                        ...
                                        <input class="form--control" type="text" name="create_username"
                                            placeholder="<?php echo e(__('Type a unique username')); ?>">
                                    </div>
                                </div>
                                ...
                                <div class="checkout-form-flex">
                                    <div class="single-input mt-4">
                                        ...
                                        <input class="form--control" type="password" name="create_password"
                                            placeholder="<?php echo e(__('Type a strong password')); ?>">
                                    </div>

                                    <div class="single-input mt-4">
                                        <label class="label-title mb-3"> <?php echo e(__('Confirm Password')); ?> </label>
                                        <input class="form--control" type="password" name="create_password_confirmation"
                        ...
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                ...
                                <textarea class="form--control form--message" name="message"
                                    placeholder="<?php echo e(__('Type Messages')); ?>"><?php echo e(old('message')); ?></textarea>
                            </div>
                        </div>
                    </form>
                </div>
...
</div><?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/themes/casual/frontend/shop/checkout/partials/checkout_left_side.blade.php ENDPATH**/ ?>