                            ...
                            <div class="banner-product-flex">
                                <div class="single-flex-banner">
                                    ...
                                    <span class="common-price-title color-one fs-18 fw-700">
                                        <?php echo e(amount_with_currency_symbol($sale_price)); ?> </span>
                                </div>
                                <div class="banner-iconlist">
                                    <a href="<?php echo e(to_product_details($product->slug)); ?>" class="banner-icon popup-modal">
            ...
            <div class="banner-socials">
                <ul class="social-lists">
                    ...
                    <li>
                        ...
                        ?>
                        <a href="<?php echo e(esc_url($url)); ?>" <?php echo e(!empty($data['new_tab']) ? 'target=""_blank' : ''); ?>>
                            <?php echo e(esc_html($title)); ?> </a>
                    </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </ul>
            </div>
            ...
            <div class="banner-right-contents-all">
                ...
                <div id="slide1" style="height: 100vh;" class="banner-images-right wow " data-wow-delay=".3s">
                    ...
                    <div class="banner-contents">
                        ...
                        <div class="animate__animated animate__fadeInRight comingsoon-btn margin-top-40">
                            <a href="<?php echo e($data['button_url'] ?? ''); ?>" class="comingsoon-order brows-category">
                                تسوق الأن
                            </a>
                        </div>
                        <?php endif; ?>
                ...
                <div id="slide2" class="banner-images-right wow asfr-img" data-wow-delay=".3s" style="">
                    ...
                    <div class="banner-contents">
                        ...
                        <?php if(!empty($data['button_text']) && !empty($data['button_url'] ?? '')): ?>
                        <div class="animate__animated animate__fadeInRight comingsoon-btn margin-top-40">
                            <a href="<?php echo e($data['button_url'] ?? ''); ?>" class="comingsoon-order brows-category"> تسوق الأن
                            </a>
                        </div>
                        <?php endif; ?>
                    </div>
...
<?php /**PATH /home/exchangemails/amstechs.com/core/plugins/PageBuilder/views/tenant/casual/header/header.blade.php ENDPATH**/ ?>