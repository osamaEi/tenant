                            ...
                            <div class="billing-items">
                                ...
                                <ul class="billing-details">
                                    ...
                                    <?php if(!empty($payment_details->coupon)): ?>
                                        <li><strong><?php echo e(__('Paid Amount After Discount :')); ?></strong> <?php echo e(amount_with_currency_symbol(optional($payment_details->package)->price)); ?></li>
                                    <?php endif; ?>
...
<?php echo $__env->make('tenant.frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/themes/casual/frontend/payment/payment-success.blade.php ENDPATH**/ ?>