...
<?php endif; ?>
                <div class="card">
                    <div class="card-body">
                        <h4 class="header-title mb-4"><?php echo e(__("Payment Gateway Settings")); ?></h4>
                        <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
                        <form action="<?php echo e(route(route_prefix().'admin.payment.settings.update')); ?>" method="POST"
...
<?php endif; ?>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <div class="form-group">
                                                    <label
                                                        for="instamojo_gateway"><strong><?php echo e(__('Enable/Disable '. ucfirst($gateway->name))); ?></strong></label>
                                                    <input type="hidden" name="<?php echo e($gateway->name); ?>_gateway">
                                                    <label class="switch">
                                                        <input type="checkbox" name="<?php echo e($gateway->name); ?>_gateway"
                                                               <?php if($gateway->status === 1 ): ?> checked <?php endif; ?> >
                                                ...
                                                <div class="form-group">
                                                    <label
                                                        for="instamojo_test_mode"><strong><?php echo e(__("Enable Test Mode"." ".ucfirst($gateway->name))); ?></strong></label>

                                                    <label class="switch">
                                                        <input type="checkbox" name="<?php echo e($gateway->name); ?>_test_mode"
                                                               <?php if($gateway->test_mode === 1): ?> checked <?php endif; ?>>
                                                        <span class="slider onff"></span>
                                                    </label>
                                                </div>

                                                <?php if (isset($component)) { $__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4 = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.landlord-others.edit-media-upload-image','data' => ['label' => ''.e(__(ucfirst($gateway->name).' '.'Logo')).'','name' => ''.e($gateway->name.'_logo').'','value' => $gateway->image]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                                                ...
                                                <?php if($gateway->name === "paystack"): ?>
                                                    <div class="form-group">
                                                        <p><?php echo e(__('Do not forget to put below url to "Settings > API Key & Webhook > Callback URL" in your paystack admin panel')); ?></p>
                                                        <input type="text" class="form-control mb-2" readonly
                                                               value="<?php echo e(tenant() ? route('tenant.user.frontend.paystack.ipn') : route('landlord.frontend.paystack.ipn')); ?>"/>
                                                    </div>
                                                <?php endif; ?>
                                                <?php
...
<?php echo $__env->make(route_prefix().'admin.admin-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/landlord/admin/payment-settings/payment_settings.blade.php ENDPATH**/ ?>