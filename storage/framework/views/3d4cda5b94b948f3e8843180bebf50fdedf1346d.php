        ...
        $(document).ready(function(){
            ...
            $(document).on('click','.add_city',function(e){
                ...
                if(city === '' || state === '' || country === ''){
                    toastr.error("<?php echo e(__('Please fill all fields !')); ?>");
                    return false;
                }
            ...
            $('#country_id').on('change', function() {
                ...
                $.ajax({
                    method: 'post',
                    url: "<?php echo e(route('tenant.admin.au.state.all')); ?>",
                    data: {
                        country: country
                    },
                    success: function(res) {
                        if (res.status === 'success') {
                            ...
                            if(all_state.length <= 0){
                                $(".info_msg").html('<small class="text-danger"> <?php echo e(__('No state found for selected country!')); ?> <span>');
                            }
                        }
                    }
                })
            ...
            function countries(page){
                $.ajax({
                    url:"<?php echo e(route('tenant.admin.city.paginate.data').'?page='); ?>" + page,
                    success:function(res){
            ...
            $(document).on('keyup','#string_search',function(){
                ...
                $.ajax({
                    url:"<?php echo e(route('tenant.admin.city.search')); ?>",
                    method:'GET',
                    data:{
                    ...
                    success:function(res){
                        if(res.status === 'nothing'){
                            $('.search_result').html('<h3 class="text-center text-danger">'+"<?php echo e(__('No Data Found')); ?>"+'</h3>');
                        }else{
                            $('.search_result').html(res);
                        }
                    }
...
<?php /**PATH /home/exchangemails/amstechs.com/core/Modules/CountryManage/Resources/views/tenant/admin/city/city-js.blade.php ENDPATH**/ ?>