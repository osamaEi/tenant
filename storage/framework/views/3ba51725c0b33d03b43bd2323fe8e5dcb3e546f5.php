...
<section class="collection-area" data-padding-top="<?php echo e($data['padding_top']); ?>"
    ...
    <div class="container-two">
        ...
        <div class="row margin-top-10">
            ...
            <div class="col-xl-3 col-md-4 col-sm-6 col-<?php echo e(productCards()); ?> margin-top-30 wow <?php echo e($class); ?>"
                ...
                <div class="signle-collection bg-item-four radius-20">
                    ...
                    <div class="collection-contents">
                        <h2 class="collection-title ff-jost">
                            <a href="<?php echo e(to_product_details($product->slug)); ?>"> <?php echo product_limited_text($product->name,
                                'title'); ?> </a>
                        </h2>
                        <div class="collection-flex-pop">
                            <div class="price-update-through margin-top-15">
                                ...
                                <span class="fs-18 flash-old-prices"> <?php echo e(amount_with_currency_symbol($regular_price)); ?>
...
</script><?php /**PATH /home/exchangemails/amstechs.com/core/plugins/PageBuilder/views/tenant/casual/product/popular_collection.blade.php ENDPATH**/ ?>