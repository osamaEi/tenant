...
<?php echo render_page_meta_data($product); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('style'); ?>
<link rel="stylesheet" href="<?php echo e(global_asset('assets/common/css/star-rating.min.css')); ?>">
...
$stock_count = $campaign_product ? $product?->campaign_product?->units_for_sale -
optional($campaignSoldCount)->sold_count ?? 0 : optional($product->inventory)->stock_count;
$stock_count = $stock_count > 0 ? $stock_count : 0;

if($campaign_product){
$campaign_title =
\Modules\Campaign\Entities\Campaign::select('id','title')->where("id",$campaign_product?->id)->first();
        ...
        <div class="row justify-content-between">
            <div class="col-xl-6 col-lg-6">
                ...
                <div class="zoom-container">
                    <!-- Include your slider images here -->
                    <?php echo $__env->make(include_theme_path('shop.product_details.partials.product-images-slider'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            ...
            <div class="col-lg-12">
                <div class="details-tab-wrapper">
                    <ul class="tabs details-tab details-tab-border">
                        ...
                        <li class="ff-jost" data-tab="reviews"> <?php echo e(__('Reviews')); ?> </li>
                        <li class="ff-jost" data-tab="ship_return"> <?php echo e(__('Ship & Return')); ?> </li>
                    </ul>

                    <?php echo $__env->make(include_theme_path('shop.product_details.partials.product-description'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php echo $__env->make(include_theme_path('shop.product_details.partials.product-reviews'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php echo $__env->make(include_theme_path('shop.product_details.partials.product-ship_return'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make(include_theme_path('shop.product_details.partials.featured-product'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<!-- Featured area end -->
<?php $__env->stopSection(); ?>
...
<script>
    $(function (){
            ...
            let year = '<?php echo e($end_date->year ?? 0); ?>';
            let month = '<?php echo e($end_date->month ?? 0); ?>';
            let day = '<?php echo e($end_date->day ?? 0); ?>';
            ...
            $(document).on('click', '#review-submit-btn', function (e){
                ...
                $.ajax({
                    url: '<?php echo e(route('tenant.shop.product.review')); ?>',
                    type: 'POST',
                    data: {
                    ...
                    beforeSend: function (){
                        toastr.warning('<?php echo e(__('Submitting please wait.')); ?>')
                        submit_btn_el.text('<?php echo e(__('Submitting..')); ?>');
                    },
                    success: function (data){
                        ...
                        submit_btn_el.text('<?php echo e(__('Submit Review')); ?>');
                    },
                    error: function (data){
            ...
            $(document).on('click', '.see-more-review', function (){
                ...
                $.ajax({
                    url: '<?php echo e(route('tenant.shop.product.review.more.ajax')); ?>',
                    type: 'GET',
                    data: {
                    ...
                    success: function (data){
                        ...
                        el.text('<?php echo e(__('See More')); ?>');
    ...
    let attribute_store = JSON.parse('<?php echo json_encode($product_inventory_set); ?>');
        ...
        function getAttributesForCart() {
            ...
            if (Object.keys(selected_options).length) {
                toastr.error('<?php echo e(__('Attribute not available')); ?>', 5000)
            }
        ...
        function syncStock(selected_options) {
            ...
            if (additional_info_store[hashed_key]) {
                ...
                if (Number(stock_count) > 0) {
                    ...
                    product_item_left_el.text(`<?php echo e(__('Only!')); ?> ${stock_count} <?php echo e(__('Item Left!')); ?>`);
                    ...
                    product_item_left_el.text(`<?php echo e(__('No Item Left!')); ?>`);
        ...
        $(document).on('click', '.but_now_single_page', function (e) {
            ...
            if (validateSelectedAttributes()) {
                $.ajax({
                    url: '<?php echo e(route("tenant.shop.product.buy.now.ajax")); ?>',
                    type: 'POST',
                    data: {
                        product_id: product_id,
                        quantity: quantity,
                    ...
                    error: function (err) {
                        toastr.error('<?php echo e(__("An error occurred")); ?>', 5000)
                    }
                });
            } else {
                toastr.error('<?php echo e(__("Select all attribute to proceed")); ?>', 5000)
            }
        });
</script>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make(route_prefix().'frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/themes/casual/frontend/shop/product_details/product-details.blade.php ENDPATH**/ ?>