                        ...
                        <div id="tab-grid2" class="tab-content-item active">
                            ...
                            <div class="row margin-top-10">
                                <?php $__currentLoopData = $products ?? []; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    ?>
                                    <div class="col-xl-3 col-md-6 margin-top-30 wow <?php echo e($class); ?>" data-wow-delay="<?php echo e($delay); ?>">
                                        <div class="signle-collection bg-item-four radius-20">
                                            <div class="collction-thumb">
                                                ...
                                                <?php endif; ?>
                                                <div class="flash-countdown-camp countdown-2 flash-countdown" data-date="<?php echo e($campaign->end_date); ?>">
                                            ...
                                            <div class="collection-contents">
                                                <h2 class="collection-title ff-jost">
                                                    <a href="<?php echo e(to_product_details($product->slug)); ?>"> <?php echo e(product_limited_text($product->name, 'title')); ?> </a>
                                                </h2>
                                                <div class="collection-flex">
                                                    <div class="price-update-through margin-top-15">
                                                        <span class="fs-22 ff-roboto fw-500 flash-prices color-one"> <?php echo e(amount_with_currency_symbol($final_price)); ?> </span>
...
<?php $__env->startSection('scripts'); ?>
    <script src="<?php echo e(global_asset('assets/tenant/frontend/js/loopcounter.js')); ?>"></script>
    <script>
        $(function () {
...
<?php echo $__env->make('tenant.frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/themes/electro/frontend/shop/campaign.blade.php ENDPATH**/ ?>