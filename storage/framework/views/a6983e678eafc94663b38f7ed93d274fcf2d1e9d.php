        ...
        <div class="container container-one">
            <div class="order-track-wrapper">
                <div class="order-track-contents order-track-padding">
                    <h2 class="order-track-contents-title fw-600"> <?php echo e(__('Order Tracking')); ?> </h2>
                    <p class="order-track-contents-para mt-4"> <?php echo e(__('To track your order please enter your Order ID in the box below and press the "Track" button. This was given to you on your receipt and in the confirmation email you should have received.')); ?> </p>
                    <form action="<?php echo e(route('tenant.shop.order.track')); ?>" class="order-track-contents-form" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="single-input mt-4">
                            <label class="label-title"> <?php echo e(__('Order ID')); ?> </label>
                            <input name="order_id" type="text" class="form--control" placeholder="<?php echo e(__('Example: 125')); ?>">
                        </div>
                        <button type="submit" class="btn-submit mt-4"> <?php echo e(__('Track Now')); ?> </button>
                    </form>

                    <?php if(session('track')): ?>
                        <div class="track-info mt-5">
                            <h5 class="text-capitalize alert <?php echo e(session('track')->status ? 'alert-success' : 'alert-danger'); ?>"><?php echo session('track')->message; ?></h5>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
...
<?php echo $__env->make('tenant.frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/themes/casual/frontend/shop/track-order.blade.php ENDPATH**/ ?>