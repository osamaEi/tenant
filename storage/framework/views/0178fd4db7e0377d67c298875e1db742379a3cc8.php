...
<?php endif; ?>
                            ...
                            <form action="<?php echo e(route('landlord.user.login.otp')); ?>" method="post" enctype="multipart/form-data" class="account-form" id="login_form_order_page">
                               <?php echo csrf_field(); ?>
...
<?php endif; ?></label>
                            ...
                            <p class="info mt-3"><?php echo e(__("Do not have an account")); ?> <a href="<?php echo e(route('landlord.user.login')); ?>" class="active"> <strong><?php echo e(__('Sign In')); ?></strong> </a></p>
                        </div>
                    </div>
                </div>
            </div>
...
<?php echo $__env->make('landlord.frontend.frontend-page-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/exchangemails/amstechs.com/core/resources/views/landlord/frontend/user/login-otp.blade.php ENDPATH**/ ?>