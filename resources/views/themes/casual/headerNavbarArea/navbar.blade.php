                                                    ...
                                                    <div class="addto-cart-flex-contents">
                                                        ...
                                                        <div class="addto-cart-img-contents">
                                                            ...
                                                            <span class="name-subtitle d-block">
                                                                ...
                                                                {{ __('Size:') }}
                                                                {{ $cart_item?->options?->size_name }}
                                                                @endif

                                                                @if ($cart_item?->options?->attributes)
                                                                <br>
                                                                @foreach ($cart_item?->options?->attributes as $key =>
                                                                $attribute)
                                                                {{ $key . ':' }}
                                                                {{ $attribute }}{{ !$loop->last ? ',' : '' }}
                                                                @endforeach
                                                            ...
                                                            <div class="price-updates margin-top-10">
                                                                <span class="price-title fs-16 fw-500 color-heading">
                                                                    {{
                                                                    amount_with_currency_symbol(calculatePrice($cart_item->price,
                                                                    $cart_item->options)) }}
                                                                </span>
                                                            </div>
                                                        </div>
                                        ...
                                        <div class="addto-cart-contents">
                                            ...
                                            <div class="cart-total-amount">
                                                <h6 class="amount-title"> {{ __('Total Amount:') }} </h6> <span
                                                    ...
                                                    {{ amount_with_currency_symbol($subtotal) }} </span>
                                            </div>
