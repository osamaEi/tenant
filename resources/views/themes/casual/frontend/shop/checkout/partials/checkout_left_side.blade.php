        ...
        <div class="checkout-inner mt-4 mt-lg-5">
            ...
            <div class="checkout-inner-contents">
                <div class="checkout-form-wrapper mt-2">
                    <form action="{{route('tenant.shop.checkout')}}" method="POST" class="checkout-form"
                        ...
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('First Name')}}
                        ...
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('Mobile Number')}}
                                    <x-fields.mandatory-indicator />
                                </label>
                                <input class="form--control" type="tel" placeholder="{{__('Type Mobile Number')}}"
                                    name="phone"
                                    value="@auth('web'){{$billing_info ? $billing_info->phone : (!empty(auth('web')->user()?->mobile) ? auth('web')->user()?->mobile : old('phone'))}}@else{{old('phone')}}@endauth"
                                    {{$readonly}}>
                            </div>
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('Email Address')}}
                                    <x-fields.mandatory-indicator />
                                </label>
                                <input class="form--control" type="email" placeholder="{{__('Type Email')}}"
                                    name="email"
                                    value="@auth('web'){{$billing_info ? $billing_info->email : auth('web')->user()?->email}}@else{{old('email')}}@endauth"
                                    {{$readonly}}>
                            </div>
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('ZIP / PIN Code')}}
                                    <x-fields.mandatory-indicator />
                                </label>
                                <input class="form--control" type="text" placeholder="{{__('ZIP / PIN Code')}}"
                        ...
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('Country')}}
                                    <x-fields.mandatory-indicator />
                                </label>
                        ...
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                <label class="label-title mb-3"> {{__('Address')}}
                                    <x-fields.mandatory-indicator />
                                </label>
                                <textarea class="form--control form--message" name="address"
                                    placeholder="{{__('Type Address')}}"
                                    {{$readonly}}>@auth('web'){{$billing_info ? $billing_info->address : (!empty(auth('web')->user()?->address) ? auth('web')->user()?->address : old('address'))}}@else{{old('address')}}@endauth</textarea>
                            </div>
                        </div>
                                ...
                                <div class="checkout-form-flex">
                                    <div class="single-input">
                                        ...
                                        <input class="form--control" type="text" name="create_username"
                                            placeholder="{{__('Type a unique username')}}">
                                    </div>
                                </div>
                        ...
                        <div class="checkout-form-flex">
                            <div class="single-input mt-4">
                                ...
                                <textarea class="form--control form--message" name="message"
                                    placeholder="{{__('Type Messages')}}">{{old('message')}}</textarea>
                            </div>
                        </div>
                    </form>
                </div>
