...
<section class="container">
        ...
        @foreach($data['categories_info'] ?? [] as $category)
            <div class="box two">
                ...
                <div class="text-info">
                   ...
                   <a href="{{route('tenant.shop.category.products', [$category->slug, 'category'])}}" class="collection-btn color-one"> مشاهدة المجموعة </a>
</p>
                </div>
            </div>
        @endforeach
    ...
    color: #fc7096 !important;" href="{{route('tenant.shop.category.products', [$category->slug, 'category'])}}" class="collection-btn color-one"> تسويق منتجات أطفال    </a><i class="las la-angle-double-left"></i></p>
            </div>
        </div>
    </div>
</section>
...
<!-- Start Second Section -->
    ...
    <section style="display: none;" class="category-area" data-padding-top="{{$data['padding_top']}}" data-padding-bottom="{{$data['padding_bottom']}}">
    <div class="container-two">
        ...
        <div class="row margin-top-10">
            @foreach($data['categories_info'] ?? [] as $index => $category)
                @php
                            ...
                            <div class="col-12">
                                <div class="single-category highlighted-category radius-20 bg-item-four text-center" style="position: relative; overflow: hidden; height: 100%;">
                                    <div class="image-contents" style="position: relative;">
                                        ...
                                        <div class="shape-circle" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; background-image: url('{{$product_bg_image}}'); background-size: cover; z-index: 1;">
                                        </div>
                                    </div>
