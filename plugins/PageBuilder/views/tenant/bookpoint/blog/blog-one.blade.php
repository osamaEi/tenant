            ...
            <div class="box-pop two">
                <div class="image-contents" style="position: relative;">
                    <div class="category-thumb" style="position: relative; z-index: 2; background: #f5f5f5;">
                        ...
                        {!! render_image_markup_by_attachment_id($item->image_id, 'lazyloads') !!}
...
<section style="display: block !important;" class="blog-area padding-top-50 padding-bottom-100" data-padding-top="{{$data['padding_top']}}"
    data-padding-bottom="{{$data['padding_bottom']}}">
